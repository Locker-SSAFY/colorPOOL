...
public class ExceptionAdvice {
	...
	protected CommonResult accessDeniedException(HttpServletRequest request, CCommunicationException e) {
		return responseService.getFailResult(Integer.parseInt(getMessage("communicationError.code")),
	...
	protected CommonResult userDuplicatedException(HttpServletRequest request, CUserDuplicatedException e) {
		return responseService.getFailResult(Integer.parseInt(getMessage("userDuplicated.code")),
			getMessage("userDuplicated.msg"));
	}
